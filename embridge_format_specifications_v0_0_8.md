...
- Items/Tasks MUST be Markdown list items that start with a marker (see "Marker Forms" below), optionally with a checkbox.
...
- Tooling SHOULD preserve the original marker style (bullet or ordered) when rewriting items.
