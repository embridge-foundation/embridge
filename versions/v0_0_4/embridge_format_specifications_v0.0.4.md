...
**Example of output** in `embridge_output_demo_v0.0.4.md`
**Author** xpiu
...
**Each property MUST be on its own line.** This allows values to contain spaces without quoting (e.g., `project:My Project Name`).
